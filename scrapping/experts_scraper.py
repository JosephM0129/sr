...
BASE_URL = "https://www.metacritic.com/publication"
headers = {
...
if __name__ == "__main__":
    ...
    query_usuario_usuario = "SELECT id_usuario FROM usuarios"
    df_usuario_usuario = query_db(query_usuario_usuario)  

    # Se obtienen los usuarios unicios de la base de datos
    query_usuario_interacciones = "SELECT distinct id_usuario FROM interacciones"
